...
SELECT 
    sd.skills,
    ROUND(MEDIAN(jpf.salary_year_avg),0) AS median_salry,
    COUNT(jpf.*) AS deman_count
...
and especially core data engineering tools (Airflow, Kubernetes) provides a strong balance between compensation and marketability

┌────────────┬──────────────┬─────────────┐
│   skills   │ median_salry │ deman_count │
